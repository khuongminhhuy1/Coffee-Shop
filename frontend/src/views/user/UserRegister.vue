<template>
  <div
    class="font-[sans-serif] bg-[url('C:\Users\user\Documents\GitHub\Coffee-Shop\frontend\src\assets\bg\noHeader-bg.jpg')] bg-amber-600 bg-cover"
  >
      ...
      >
        <div class="md:max-w-md w-full px-4 py-4">
          <form @submit.prevent="register">
            <div class="mb-12">
              <h3 class="text-gray-800 text-3xl font-extrabold uppercase">register</h3>
              <p class="text-sm mt-4 text-gray-800">
                Already have an account ?
                <router-link
                  to="/login"
                  class="text-lime-600 font-semibold hover:underline ml-1 whitespace-nowrap"
                  >Login here</router-link
                >
              </p>
            </div>
            <div>
              <label class="text-gray-800 text-xs block mb-2 font-extrabold">Name</label>
            ...
            <div class="mt-8">
              <label class="text-gray-800 text-xs block mb-2 font-extrabold">Email</label>
              <div class="relative flex items-center">
                <input
                  name="email"
                  type="text"
            ...
            <div class="mt-8">
              <label class="text-gray-800 text-xs block mb-2 font-extrabold">Password</label>
              <div class="relative flex items-center">
                <input
                  name="password"
                  type="password"
            ...
            <div class="mt-8">
              <label class="text-gray-800 text-xs block mb-2 font-extrabold"
            ...
            <div class="mt-8 flex flex-row items-center">
              ...
              />
              <p>I accept the <a href="#">Terms of Service</a></p>
            </div>
            <div class="mt-8">
              <button
                type="submit"
